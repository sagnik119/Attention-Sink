...
class CausalSelfAttention(nn.Module):
    ...
    def forward(
        ...
        # print(f"initialized variance of proj: {math.sqrt(2.0 / 5 / self.proj.weight.size(1))}, actual variance of proj: {self.proj.weight.std()}")
